				...
				<ul class="listBrand">
					<c:forEach items="${listBrand}" var="brand">
						<li class="list-brand__item">
							...
							<label for="${brand.brandId}" class="lab-brand"><img class="logo-brand" alt="Logo Brand" src="${brand.logo}"></label>
						</li>
					</c:forEach>
						...
						<div class="group-quantity-price">
							<div class="form-group brand-logo">
								...
								<select  class="form-control" id="brandId" name ="brandEntity.brandId">
									<option selected="selected">Choose a brand...</option>
									<c:forEach items="${listBrand}" var="brand">
	...
	<div class="modal fade" id="confirmDeleteModal" >
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
					<button type="button" class="btn btn-primary" id="deleteSubmitBtn">OK</button>
				</div>
			</div>
		</div>
	</div>
